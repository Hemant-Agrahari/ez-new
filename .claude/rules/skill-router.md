...
## Step 0: Project Mandates (CRITICAL)

BEFORE doing anything, read `.claude/rules/project-mandates.md` and ensure the response adheres to the project's Core Web Vitals, Vanilla JS, and SEO standards.
